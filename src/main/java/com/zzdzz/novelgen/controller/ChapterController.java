...
public class ChapterController {
    ...
    public Result<List<ChapterListItemVO>> list(@PathVariable long novelId) {
        return Result.success(chapterQueryService.listByNovel(novelId));
    }
    ...
    public Result<List<ChapterListItemVO>> pendingApprovals(@PathVariable long novelId) {
        return Result.success(chapterQueryService.pendingApprovals(novelId));
    }

    @GetMapping("/chapters/{id}")
    public Result<ChapterDetailVO> detail(@PathVariable long id) {
        return Result.success(chapterQueryService.detail(id));
    }
    ...
    public Result<Long> reject(@PathVariable long id, @RequestBody(required = false) RejectVO req) {
        ...
        return Result.success(queueService.submitById(target.novelId(), target.novelTitle(),
    ...
    public Result<ChapterPipelineService.SceneEditResult> editScene(@PathVariable long id, @RequestBody(required = false) SceneEditVO req) {
        ...
        return Result.success(pipelineService.editSceneDraft(id, text));
    }
    ...
    public Result<ReviewVO> review(@PathVariable long id) {
        ...
        return Result.success(chapterQueryService.latestReview(id));
    }
